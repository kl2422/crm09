    ...
    <form id="fm" method="post">
        <table cellspacing="15px">
            <tr>
                <td>服务类型：</td>
                <td>
                    <input class="easyui-combobox" id="serveType" name="serveType" data-options="panelHeight:'auto',editable:false,valueField:'dataDicValue',textField:'dataDicValue',url:'${ctx}/datadic/dataDicComboList.do?dataDicName=服务类型'"/>&nbsp;<font color="red">*</font>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>客户：</td>
            ...
            <input type="hidden" id="createPeople" name="createPeople" />
            <tr>
                <td colspan="4"></td>
                <td>
